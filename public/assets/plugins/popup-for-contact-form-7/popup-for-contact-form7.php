...
jQuery("body").append(popHtml);	
				...
				if(jsonResponse["status"] === 'mail_sent')
				{
					...
					setTimeout(function(){
						...
						// confirm box
						 ...
						 /*if(confirm("Are you sure to submit another ?"))
						 {
                document.getElementById("submitMusicForm").style.display="block";
              }else{
                document.getElementById("submitMusicForm").style.display="none";
                document.getElementById("submitClickBtn").style.display="";
	...
	jQuery("#btnSubmitAnother").click(function(event){
	  jQuery( ".js-modal-close" ).trigger( "click" );
	  document.getElementById("submitMusicForm").style.display="block";
