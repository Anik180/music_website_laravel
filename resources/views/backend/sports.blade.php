...
<div class="content-wrapper">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm">
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addModal"><i class="fas fa-plus-circle"></i> Add</button>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body table-responsive p-0">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <form action="{{ url('admin/sort-update') }}" method="POST">
                                            @csrf
                                            <div class="input-group input-group-sm">
                                    ...
                                    <td>{{$list->title}}</td>
                                    <td>
                                        <img src="{{ ($list->image)? asset(config('app.f_url').'/storage/app/public/uploads/Sports/'.$list->image) :asset(config('app.f_url').'/default.jpg')}}" width="60">
                                        <a href="{{ ($list->image)? asset(config('app.f_url').'/storage/app/public/uploads/Sports/'.$list->image) :asset(config('app.f_url').'/default.jpg')}}" class="btn btn-info btn-sm" title="Download" download><i class="fas fa-download"></i></a>
                                    ...
                                    <td>
                                        ...
                                        <form id="delete-form-{{$list->id}}" action="{{url('admin/sports-destroy',$list->id)}}" method="post" style="display: none;">
                                            @csrf
                                        </form>
                                    </td>
                                </tr>
    ...
    <div class="modal fade" id="addModal" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            ...
            <form method="POST" action="{{url('admin/sports')}}" enctype="multipart/form-data">
                @csrf
    ...
    <div id="modal-edit" class="modal fade" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="{{url('admin/sports-update')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="modal-body">
                            <div class="form-group">
...
<div id="imageUpload" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data" action="{{url('admin/sports-image-update')}}">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                    ...
                    <input type="hidden" name="sports_id" id="image_expertise_id">
                </div>
                <div class="modal-footer">
