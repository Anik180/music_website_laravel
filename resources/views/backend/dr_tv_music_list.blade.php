...
<div class="content-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach($music_list as $key=>$list)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>{{$list->name}}</td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <form id="delete-form-{{$list->id}}" action="{{url('admin/dr-tv/music-delete',$list->id)}}" method="post" style="display: none;">
                                            @csrf
                                        </form>
                                    </td>
                                </tr>
    ...
    <div class="modal fade" id="addModal" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            ...
            <form method="POST" action="{{url('admin/dr-tv/music-store')}}" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    ...
                    <input type="hidden" name="dr_tv_id" value="{{$dr_tv_id}}">
                </div>
    ...
    <div id="modal-edit" class="modal fade" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="{{url('admin/dr-tv/music-update')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="modal-body">
                            <div class="form-group">
...
<div id="imageUpload" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data" action="{{url('admin/dr-tv/music-upload')}}">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label>Music</label>
